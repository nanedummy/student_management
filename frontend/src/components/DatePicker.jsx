...
export default function DatePicker({ name, value, onChange, required = false, className = '', style = {}, placeholder = 'Select Date' }) {
  ...
  return (
    <div className="clay-datepicker-container" ref={containerRef} style={style}>
      <input
        type="text"
        readOnly
        className={`form-control clay-datepicker-input ${className}`}
        value={displayValue}
